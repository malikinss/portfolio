""" 
Task: A geometric progression is a sequence of numbers b1, b2, ..., bn, each of which, starting from b2, is obtained from the previous one by multiplying by the same constant number q (the denominator of the progression), that is:
